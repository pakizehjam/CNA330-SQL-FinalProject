...
# ( We can see here that this Database have 3910 FREE Apps and have a rate between 4.2 and 4.6)
plt.title("Free Apps")
...
# (We can see that the database has 115 apps with a highest rate for business category is between 4.2nd 4.6)
